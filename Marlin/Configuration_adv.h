...
#define CUSTOM_USER_MENUS //MODIFIED
  ...
  #define USER_GCODE_1 "G28 X Y"  //IMPLEMENTED AND TESTED ON ACTUAL HARDWARE

  #define USER_DESC_2 "LASER FOCUS"
  #define USER_GCODE_2 "M1500" //IMPLEMENTED BUT NOT TESTED ON ACTUAL HARDWARE

  #define USER_DESC_3 "LASER OFF"
  #define USER_GCODE_3 "M5" //IMPLEMENTED AND TESTED ON ACTUAL HARDWARE //CAN BE CHANGED TO DIRECT LASER_CONTROL ALGORITM

  #define USER_DESC_4 "LASER AT 25%"
  #define USER_GCODE_4 "M3 O64" //IMPLEMENTED AND TESTED ON ACTUAL HARDWARE //CAN BE CHANGED TO DIRECT LASER_CONTROL ALGORITM

  #define USER_DESC_5 "LASER AT 50%"
  #define USER_GCODE_5 "M3 O128" //IMPLEMENTED AND TESTED ON ACTUAL HARDWARE //CAN BE CHANGED TO DIRECT LASER_CONTROL ALGORITM

  #define USER_DESC_6 "LASER AT 100%"
  #define USER_GCODE_6 "M3 O255" //IMPLEMENTED AND TESTED ON ACTUAL HARDWARE //CAN BE CHANGED TO DIRECT LASER_CONTROL ALGORITM
#endif
